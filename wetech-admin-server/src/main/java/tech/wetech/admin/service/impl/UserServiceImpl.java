...
import tech.wetech.admin.model.dto.*;
...
public class UserServiceImpl implements UserService {
    ...
    public UserTokenDTO login(LoginDTO loginDTO) {
        ...
        if(loginDTO.getUsername() != null){
            ...
            user = userMapper.selectByEmail(loginDTO.getEmail());
        }
        if (user == null) {
    ...
    @Override
    public ResDTO register(RegisterDTO registerDTO) {
        User Fuser = userMapper.selectByUsername(registerDTO.getUsername());
        if( Fuser != null ){
            throw new BusinessException(CommonResultStatus.FAILED_USER_ALREADY_EXIST);
        } else {
            User user = new User();
