...
import tech.wetech.admin.model.dto.RegisterDTO;
...
public class LoginController {
    ...
    public Result<ResDTO> register(@RequestBody RegisterDTO acceptDTO) {
        ResDTO resDTO = userService.register(acceptDTO);
